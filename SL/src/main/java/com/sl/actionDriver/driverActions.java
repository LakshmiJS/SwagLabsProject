...
import com.sl.base.baseClass;

public class driverActions  extends baseClass {
	

	public static void newClick(WebDriver driver, WebElement eleName) throws Exception
	{
		...
		{System.out.println("In type method"+ele);
			boolean flag=false;
			try {
				flag = ele.isDisplayed();
				System.out.println("In type method");
				ele.clear();
				findElement(getDriver(), ele);
				//ele.sendKeys(text);
